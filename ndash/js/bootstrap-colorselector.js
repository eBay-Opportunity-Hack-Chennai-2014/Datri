...
(function($) {
  ...
  ColorSelector.prototype = {
    ...
    _init : function() {
      ...
      //var $markupSpan = $("<span>").addClass("btn-colorselector").css("background-color", selectColor);//Original 
      var $markupSpan = $("<span>").addClass("glyphicon glyphicon-tint").css("color", selectColor);
      ...
      this.$select.on("change", function() {
        ...
        //$(this).next().find(".btn-colorselector").css("background-color", color);//Original
        $(this).next().find(".glyphicon-tint").css("color", color);
        
        //callback(value, color, title); // Original
