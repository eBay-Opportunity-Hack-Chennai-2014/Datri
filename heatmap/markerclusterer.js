...
Cluster.prototype.addMarker = function(marker) {
  ...
  var totalCount = 0;
	for(var i=0, marker1; marker1 = this.markers_[i];i++) {
	var markerPosition = marker1.getPosition();
	var count = marker1.count;
	totalCount += count;
	latsum += markerPosition.lat()*count;
	lonsum += markerPosition.lng()*count;
	}
	var avglat = latsum/totalCount, avglon = lonsum/totalCount;
	//avglat = avglat/totalCount;
	//avglon = avglon/totalCount;
	var myLatlng = new google.maps.LatLng(avglat, avglon);
	this.center_ = myLatlng;
	this.calculateBounds_();
